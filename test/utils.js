...
describe('Utils', function() {
  ...
  describe('#getAddressCoin', function() {
    it('should identify ltz as coin for t1Xxa5ZVPKvs9bGMn7aWTiHjyHvR31XkUst', function() {
      Utils.getAddressCoin('t1Xxa5ZVPKvs9bGMn7aWTiHjyHvR31XkUst').should.equal('ltz');
    });
